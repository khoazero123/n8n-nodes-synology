...
async function createWorkflow(credential) {
	...
	const nodes = [
		...
		{ name: 'Create Shelf', type: 'CUSTOM.synologyNoteStation', typeVersion: 1, position: [1680, 0], parameters: { resource: 'shelf', operation: 'create', name: `n8n shelf E2E ${unique}` }, credentials: { synologyApi: { id: credential.id, name: credential.name } } },
		{ name: 'Rename Shelf', type: 'CUSTOM.synologyNoteStation', typeVersion: 1, position: [1800, 0], parameters: { resource: 'shelf', operation: 'rename', stackId: "={{ $('Create Shelf').item.json.stack_id || $('Create Shelf').item.json.object_id }}", name: `n8n renamed shelf E2E ${unique}` }, credentials: { synologyApi: { id: credential.id, name: credential.name } } },
		{ name: 'Share User', type: 'CUSTOM.synologyNoteStation', typeVersion: 1, position: [1920, 0], parameters: { resource: 'share', operation: 'setUser', shareObjectId: "={{ $('Create Note Full').item.json.object_id }}", principalName: process.env.SYNO_SHARE_USER || 'nas', permission: 'ro' }, credentials: { synologyApi: { id: credential.id, name: credential.name } } },
		{ name: 'Remove User Share', type: 'CUSTOM.synologyNoteStation', typeVersion: 1, position: [2040, 0], parameters: { resource: 'share', operation: 'removeUser', shareObjectId: "={{ $('Create Note Full').item.json.object_id }}", principalName: process.env.SYNO_SHARE_USER || 'nas' }, credentials: { synologyApi: { id: credential.id, name: credential.name } } },
		{ name: 'Share Group', type: 'CUSTOM.synologyNoteStation', typeVersion: 1, position: [2160, 0], parameters: { resource: 'share', operation: 'setGroup', shareObjectId: "={{ $('Create Note Full').item.json.object_id }}", principalName: process.env.SYNO_SHARE_GROUP || 'users', permission: 'ro' }, credentials: { synologyApi: { id: credential.id, name: credential.name } } },
		{ name: 'Remove Group Share', type: 'CUSTOM.synologyNoteStation', typeVersion: 1, position: [2280, 0], parameters: { resource: 'share', operation: 'removeGroup', shareObjectId: "={{ $('Create Note Full').item.json.object_id }}", principalName: process.env.SYNO_SHARE_GROUP || 'users' }, credentials: { synologyApi: { id: credential.id, name: credential.name } } },
		{ name: 'Delete Shelf', type: 'CUSTOM.synologyNoteStation', typeVersion: 1, position: [2400, 0], parameters: { resource: 'shelf', operation: 'delete', stackId: "={{ $('Create Shelf').item.json.stack_id || $('Create Shelf').item.json.object_id }}" }, credentials: { synologyApi: { id: credential.id, name: credential.name } } },
